        ...
        <div>
            <Row className='mt-5 mx-4'>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 1</a></Card.Title>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 2</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 3</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 4</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
            ...
            <Row className='mt-5 mx-4'>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 5</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 6</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 7</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        <Card.Body>
                            <Card.Title><a className='linkcss' onClick={()  => {navigate('/ExampleMouse')}}>Mouse 8</a></Card.Title>
                            <Card.Img variant="top" src={require('./examples/mouse.jpg')}  className='photo' />
                            <Card.Text>
                                description
                            </Card.Text>
