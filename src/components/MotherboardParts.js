            ...
            <Row className='mt-5 mx-4'>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 1')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 2')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 3')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 4')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
            <Row className='mt-5 mx-4'>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 5')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 6')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 7')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            <Button onClick={() =>  addToBuild('motherboard', 'Motherboard 8')}>add to build</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
